document.addEventListener("DOMContentLoaded", () => {
            ...
            const res = await fetch(
                `https://wordsapiv1.p.rapidapi.com/words/${guessedWord.toLowerCase()}`,
                {
                    ...
                    headers: {
                        ...
                        "x-rapidapi-key": "be135cb431msh72158ce16dc8137p128c7ajsn2f7669679b4a",
                    },
                }
            );
    ...
    function initThemeModal() {
        ...
        // Get the button that opens the modal
        const btn = document.getElementById("themes");

        // Get the <span> element that closes the modal
        const span = document.getElementById("close-themes");
